...
public class Game extends JFrame {
	...
	public Game() {
		...
		addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				...
				case KeyEvent.VK_P:
					if(!checkForRestart()) {
						_arch.OUT_IClock.setPaused(!_arch.OUT_IClock.isPaused());
					}
					break;
	...
	public void startGame() {
		...
		this.player1 = _arch.OUT_IPlayer1.createPlayer();
		this.player2 =_arch.OUT_IPlayer2.createPlayer() ;
		...
		while(true) {
			 ...
			 */
			_arch.OUT_IClock.update();
			for(int i = 0; i < 5 && _arch.OUT_IClock.hasElapsedCycle(); i++) {
				updateGame();
			}
	...
	public void resetGame() {
		...
		this.level = 0;
		this.getPlayer1().lives = 3;
		this.getPlayer2().lives = 3;
	...
	public void resetEntityLists() {
		pendingEntities.clear();
		entities.clear();
		if(this.getPlayer1().lives!=0)
		{entities.add(player1);}
		if(this.getPlayer2().lives!=0)
	...
	public boolean isPaused() {
		return _arch.OUT_IClock.isPaused();
	}
