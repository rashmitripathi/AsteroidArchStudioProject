...
public class WorldPanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		while(iter.hasNext()) {
			 ...
			 */
			if((entity != game.getPlayer1()&&entity!=game.getPlayer2()) || game.canDrawPlayer()) {
		...
		if(!game.isGameOver()) {
			g.drawString("Score 1- " + game.getPlayer1().score, 10, 15);
			g.drawString("Score 2- " + game.getPlayer2().score, 80, 15);
		...
		if(game.isGameOver()) {
			...
			drawTextCentered("Final Score(Player1): " + game.getPlayer1().score, SUBTITLE_FONT, g2d, 10);
			drawTextCentered("Final Score(Player 2): " + game.getPlayer2().score, SUBTITLE_FONT, g2d, 25);
		...
		g2d.translate(15, 30);
		g2d.scale(0.85, 0.85);
		for(int i = 0; i < game.getPlayer1().lives; i++) {
		...
		for(int i = 0; i < game.getPlayer2().lives; i++) {
			g2d.drawLine(-8, 10, 0, -10);
			g2d.drawLine(8, 10, 0, -10);
			g2d.drawLine(-6, 6, 6, 6);
			g2d.translate(30, 0);
