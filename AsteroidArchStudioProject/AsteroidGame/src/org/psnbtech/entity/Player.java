...
public class Player extends Entity {
	...
	public void handleCollision(Game game, Entity other) {
		...
		if(other.getClass() == Asteroid.class) {
			System.out.println("Life of player is :"+lives);
	...
	public void setArchData(Player1Arch _arch)
	{
		this._arch=_arch;
	}
	
	public void setArchData(Player2Arch _arch2)
	{
		this._arch2=_arch2;
	}
	@Override
